defmodule EventumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EventumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EventumWeb.Gettext, "errors", msg, opts)
    end
  end
